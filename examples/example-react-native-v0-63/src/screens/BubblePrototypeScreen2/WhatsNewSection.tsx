            ...
            case 'WAITING_FOR_LAYOUT':
                return (
                    <View style={styles.notReadyForDisplayContainer}>
                        <ActivityIndicator
                            animating={true}
                            color={props.sectionThemeConfig?.sectionTitleColor ?? 'rgba(255,255,255,0.3)'}
                        />
                    </View>
                );
                        ...
                        {MOCK_DEBUG_CONFIG.showBubbleGroupBoundingBox && (
                            <View 
                                style={{
                                    ...
                                    transform: [
                                        {
                                            translateX: whatsNewLayout.state.hexagonGroupBoundingBox.minX,
                                        },
                                        {
                                            translateY: whatsNewLayout.state.hexagonGroupBoundingBox.minY,
                                        },
                                    ],
                                }}
                            />
            ...
            <View style={styles.rootContainer}>
                ...
                {MOCK_DEBUG_CONFIG.isDebug && (
                    <Text>
                        ...
                        {'\n'}
                        {`hexagonCount: ${(whatsNewLayout.state as Record<string, any>).hexagons?.length}`}
                    </Text>
                )}
                {MOCK_DEBUG_CONFIG.isDebug && (
                    <DebugStepper
