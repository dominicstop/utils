...
export class InterpolationHelpers {
    ...
    */
    ...
    public static rangedLerpUsingInputValue(
        inputValue: number,
    ...
    public static rangedLerpUsingRelativePercent(
    ...
    public static rangedLerpUsingArray(
        inputValue: number,
        ...
        if(inputValue < rangeInput[0]){
            ...
            return this.rangedLerpUsingInputValue(
