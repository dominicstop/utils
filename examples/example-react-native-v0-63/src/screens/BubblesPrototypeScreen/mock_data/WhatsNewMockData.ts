...
import { WhatsNewEntry, WhatsNewPayload } from "../WhatsNewService";
...
const MOCK_ARTICLE_URL_MAP: Record<MockKey, string> = {
  mock00: "https://www.cimb.com/en/home.html",
  mock01: "https://www.cimb.com/en/who-we-are/contact-us.html",
  mock02: "https://www.cimb.com/en/newsroom.html",
  mock03: "https://www.cimb.com/en/who-we-are/awards.html",
  mock04: "https://www.cimb.com/en/careers/working-at-cimb.html",
  mock05: "https://www.cimb.com/en/who-we-are/contact-us.html",
  mock06: "https://www.cimb.com/en/newsroom/2025/cimb-commits-rm10-billion-to-accelerate-growth-in-johor-singapore-special-economic-zone.html",
};
...
export const WHATS_NEW_MOCK_RESPONSE: WhatsNewPayload = (() => {
  ...
  for(const key in MOCK_KEYS){
    ...
    entries.push({
      index: index++,
      articleURL: MOCK_ARTICLE_URL_MAP[mockKey],
...
export function replaceMockImageURLWithLocalMockImageURI(payload: WhatsNewPayload){
